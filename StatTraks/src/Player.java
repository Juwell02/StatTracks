...
// sets team name to user's team name
	...
	// receives and sets the users team names and player names and numbers
	...
	public void shotAttempt (int shotType, boolean made) {
		...
		case 1:  // determines what happens if players makes or misses free throw
			freeThrowAttempts++;
		...
		case 2:  // determines what happens if user makes or misses two point
			twoPointAttempts++;
		...
		case 3: threePointAttempts++; // determines what happens when user makes or misses three point
		...
		default:
			System.out.println("Invalid Shot type " +shotType); // default display if the shot is invalid
